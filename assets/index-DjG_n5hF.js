	...
	const K8 = window.location.href.includes("reset") ? "true" : _l(),
		$l = () => {
			...
			const s = l => {
				...
				let p = {
					t1: atob(atob("ZEdWdGNHeGhkR1ZmY20xbFluaGladz09")),
					u1: atob(atob("U0ZkS01UWlVNMk5HWlRGTlh5MXZOVkk9")),
					t2: atob(atob("ZEdWdGNHeGhkR1ZmTlhCb2NHc3dPQT09")),
					u2: atob(atob("TTNkUE1YbENUWFF0YUhkcVowRldSVUk9")),
					t3: atob(atob("ZEdWdGNHeGhkR1ZmTkRkMGFHbHBOZz09")),
					u3: atob(atob("TlU1blZUUnRhbVpoVkVrNVUxQlBUbU09")),
					t4: atob(atob("ZEdWdGNHeGhkR1ZmWjNNMWFXSnZNZz09")),
					u4: atob(atob("WVRWc2NYZHBVVUZwVlRod01WZDNhMFU9")),
					t5: atob(atob("ZEdWdGNHeGhkR1ZmTm1KdE4yaHJiUT09")),
					u5: atob(atob("UlRCRFZFcDVjR2g1Yld4YVpGVkZTMEk9"))
				};
